...
Description: This .hpp implements a trie node to hold characters, and a trie of trie Nodes
*/
#pragma once
#include <iostream>
...
//Trie class links a bunch of trie nodes together and has the ability to search through them to return prefixes
class Trie
{
private:
